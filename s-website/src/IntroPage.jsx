    ...
    return (
        <>
            <div className="flex text-white">
                <div className="flex-1 ml-[100px] tracking-widest">
                    ...
                    <a href="signup">
                        <button className=" mt-5 bg-transparent outline-[#59A3F9] outline text-white text-[15px] font-bold rounded-lg py-3 px-[190px]">
                            SIGN UP
                        </button>
                    </a>
                </div>
