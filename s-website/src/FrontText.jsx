        ...
        <>
            <div class="flex text-white">
                <div class="flex-1 ml-[100px] tracking-widest">
                    ...
                    <button class=" mt-5 bg-[#59A3F9] outline-[#59A3F9] text-white text-[15px] font-bold rounded-lg py-3 px-[190px]">SIGN IN</button>
                    <button class=" mt-5 bg-transparent outline-[#59A3F9] outline text-white text-[15px] font-bold rounded-lg py-3 px-[190px]">SIGN UP</button>
                </div>
                <div class="flex-1">
                    <img src="icon2.png"className="w-[500px]"/>
                </div>
            </div>
        </>
    )
