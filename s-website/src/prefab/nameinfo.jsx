    ...
    return (
        <>
            {(userRole == "visitor" || userRole == "student") ?
                <div
                    className="cursor-default float-left text-left grid grid-cols-4 gap-56 mt-[10px] bg-[#D9D9D9] outline-[#D9D9D9] w-[950px] outline text-black text-[20px] py-2 font-bold rounded-2xl pr-[80px] pl-5 ml-[25px] mb-3">
